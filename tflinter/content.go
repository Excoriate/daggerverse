...
func (m *Tflinter) CloneGitRepoHTTPS(
...
func (m *Tflinter) CloneGitRepoSSH(
	// repoURL is the URL of the git repo to clone.
	repoURL string,
...
func (m *Tflinter) getTokenNameByVcs(vcs string) string {
	if vcs == "gitlab" {
		return "GITLAB_TOKEN"
	}
...
func (m *Tflinter) getTokenValueBySecret(secret *dagger.Secret) string {
