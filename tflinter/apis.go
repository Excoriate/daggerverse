...
//     Optional parameter.
func (m *Tflinter) WithEnvironmentVariable(
...
func (m *Tflinter) WithFileMountedInContainer(
	file *dagger.File,
	dest string,
	owner string,
) *Tflinter {
...
//
// Returns:
//   - *Tflinter: The updated Tflinter with the environment variable set.
//
// Behavior:
//   - The secret value is expanded according to the current environment variables defined in the container.
func (m *Tflinter) WithSecretAsEnvVar(name string, secret *dagger.Secret) *Tflinter {
...
//
// Returns:
//   - *Tflinter: The updated Tflinter with the downloaded file mounted in the container.
func (m *Tflinter) WithDownloadedFile(
...
//
// Returns:
//   - *Tflinter: The updated Tflinter with the cloned repository mounted in the container.
func (m *Tflinter) WithClonedGitRepoHTTPS(
	repoURL string,
...
// Returns:
//   - *Tflinter: The updated Tflinter with the cloned repository mounted in the container.
func (m *Tflinter) WithClonedGitRepoSSH(
...
//
// Returns:
//   - *Tflinter: The updated Tflinter with the cache-busting environment variable set.
func (m *Tflinter) WithCacheBuster() *Tflinter {
	m.Ctr = m.Ctr.
...
//
// Returns:
//   - *Tflinter: The updated Tflinter with the config file mounted in the container.
func (m *Tflinter) WithConfigFile(
...
func (m *Tflinter) WithCachedDirectory(
...
func (m *Tflinter) WithUserAsOwnerOfDirs(
...
func (m *Tflinter) WithUserWithPermissionsOnDirs(
	// user is the user to set as the owner of the directories.
	user string,
