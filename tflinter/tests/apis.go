...
import (
	...
	"github.com/Excoriate/daggerverse/tflinter/tests/internal/dagger"
...
func (m *Tests) TestWithEnvironmentVariable(ctx context.Context) error {
	targetModule := dag.
		Tflinter().
		WithEnvironmentVariable("HOST", "localhost", dagger.TflinterWithEnvironmentVariableOpts{
			Expand: false,
		})

	targetModule = targetModule.
		WithEnvironmentVariable("PORT", "8080", dagger.TflinterWithEnvironmentVariableOpts{
			Expand: false,
		})

	targetModule = targetModule.
		WithEnvironmentVariable("USER", "me", dagger.TflinterWithEnvironmentVariableOpts{
			Expand: false,
		})
...
func (m *Tests) TestWithDownloadedFile(ctx context.Context) error {
	...
	targetModule = targetModule.
		WithDownloadedFile(fileURL, dagger.TflinterWithDownloadedFileOpts{
...
func (m *Tests) TestWithClonedGitRepoHTTPS(ctx context.Context) error {
	...
	targetModule = targetModule.
		WithClonedGitRepoHTTPS("https://github.com/excoriate/daggerverse",
			dagger.TflinterWithClonedGitRepoHTTPSOpts{})
...
func (m *Tests) TestWithConfigFile(ctx context.Context) error {
	...
	targetModule := dag.
		Tflinter().
		WithConfigFile(file, dagger.TflinterWithConfigFileOpts{
...
func (m *Tests) TestWithUserAsOwnerOfDirs(ctx context.Context) error {
	...
	targetModule = targetModule.
		WithUserAsOwnerOfDirs("me", listOfDirsToOwn,
			dagger.TflinterWithUserAsOwnerOfDirsOpts{
				Group:           "mygroup",
