...
//     Optional parameter.
func (m *Gopkgpublisher) WithEnvironmentVariable(
...
func (m *Gopkgpublisher) WithSource(
...
func (m *Gopkgpublisher) WithContainer(
...
//
// Returns:
//   - *Gopkgpublisher: The updated Gopkgpublisher with the cache-busting environment variable set.
func (m *Gopkgpublisher) WithCacheBuster() *Gopkgpublisher {
	m.Ctr = m.Ctr.
...
func (m *Gopkgpublisher) WithCachedDirectory(
...
//
// Returns:
// - *Gopkgpublisher: The updated Gopkgpublisher instance with the ownership of the specified directories changed.
func (m *Gopkgpublisher) WithUserAsOwnerOfDirs(
...
//
// Returns:
// - *Gopkgpublisher: The updated Gopkgpublisher instance with the permissions of the specified directories changed.
func (m *Gopkgpublisher) WithUserWithPermissionsOnDirs(
	// user is the user to set as the owner of the directories.
	// +optional
	user string,
