...
This module includes a [testing](module/tests) module that aims to test the functionality of the Ctrutils module. The tests are written in Go and can be run using the following command:
