...
func (m *Tests) TestWithEnvironmentVariable(ctx context.Context) error {
	targetModule := dag.
		Gotest().
		WithEnvironmentVariable("HOST", "localhost", dagger.GotestWithEnvironmentVariableOpts{
			Expand: false,
		})

	targetModule = targetModule.
		WithEnvironmentVariable("PORT", "8080", dagger.GotestWithEnvironmentVariableOpts{
			Expand: false,
		})

	targetModule = targetModule.
		WithEnvironmentVariable("USER", "me", dagger.GotestWithEnvironmentVariableOpts{
			Expand: false,
		})
...
func (m *Tests) TestWithDownloadedFile(ctx context.Context) error {
	...
	targetModule = targetModule.
		WithDownloadedFile(fileURL, dagger.GotestWithDownloadedFileOpts{
...
func (m *Tests) TestWithClonedGitRepoHTTPS(ctx context.Context) error {
	...
	targetModule = targetModule.
		WithClonedGitRepoHTTPS("https://github.com/excoriate/daggerverse",
			dagger.GotestWithClonedGitRepoHTTPSOpts{})
...
func (m *Tests) TestWithConfigFile(ctx context.Context) error {
	...
	targetModule := dag.
		Gotest().
		WithConfigFile(file, dagger.GotestWithConfigFileOpts{
...
func (m *Tests) TestWithUserAsOwnerOfDirs(ctx context.Context) error {
	...
	targetModule = targetModule.
		WithUserAsOwnerOfDirs("me", listOfDirsToOwn,
			dagger.GotestWithUserAsOwnerOfDirsOpts{
				Group:           "mygroup",
