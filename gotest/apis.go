...
func (m *Gotest) WithFileMountedInContainer(
	file *dagger.File,
	dest string,
	owner string,
) *Gotest {
...
//
// Returns:
//   - *Gotest: The updated Gotest with the environment variable set.
//
// Behavior:
//   - The secret value is expanded according to the current environment variables defined in the container.
func (m *Gotest) WithSecretAsEnvVar(name string, secret *dagger.Secret) *Gotest {
...
//
// Returns:
//   - *Gotest: The updated Gotest with the downloaded file mounted in the container.
func (m *Gotest) WithDownloadedFile(
...
//
// Returns:
//   - *Gotest: The updated Gotest with the cloned repository mounted in the container.
func (m *Gotest) WithClonedGitRepoHTTPS(
	repoURL string,
...
// Returns:
//   - *Gotest: The updated Gotest with the cloned repository mounted in the container.
func (m *Gotest) WithClonedGitRepoSSH(
...
//
// Returns:
//   - *Gotest: The updated Gotest with the cache-busting environment variable set.
func (m *Gotest) WithCacheBuster() *Gotest {
	m.Ctr = m.Ctr.
...
//
// Returns:
//   - *Gotest: The updated Gotest with the config file mounted in the container.
func (m *Gotest) WithConfigFile(
...
func (m *Gotest) WithCachedDirectory(
...
func (m *Gotest) WithUserAsOwnerOfDirs(
...
func (m *Gotest) WithUserWithPermissionsOnDirs(
	// user is the user to set as the owner of the directories.
	user string,
