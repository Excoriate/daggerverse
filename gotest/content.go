...
func (m *Gotest) CloneGitRepoHTTPS(
...
func (m *Gotest) getTokenNameByVcs(vcs string) string {
	if vcs == "gitlab" {
		return "GITLAB_TOKEN"
	}
...
func (m *Gotest) getTokenValueBySecret(secret *dagger.Secret) string {
