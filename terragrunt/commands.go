...
func (m *Terragrunt) RunShell(cmd string) (string, error) {
...
// Usage example:
// ```go
// envVars, err := TerragruntInstance.PrintEnvVars()
//
//	if err != nil {
...
//
// fmt.Println(envVars).
func (m *Terragrunt) PrintEnvVars() (string, error) {
	out, err := m.
		Ctr.
...
func (m *Terragrunt) InspectEnvVar(key string) (string, error) {
