...
func (m *Terragrunt) WithGoPlatform(
	// platform is the target platform specified in the format "[os]/[platform]/[version]".
	// For example, "darwin/arm64/v7", "windows/amd64", "linux/arm64". If the platform
	// is not provided, it defaults to "linux/amd64".
	// +optional
...
// Returns:
// - *Terragrunt: A pointer to the updated Terragrunt instance.
func (m *Terragrunt) WithGoCgoEnabled() *Terragrunt {
...
// Returns:
// - *Terragrunt: A pointer to the updated Terragrunt instance.
func (m *Terragrunt) WithCgoDisabled() *Terragrunt {
...
// Returns:
// - *Terragrunt: A pointer to the updated Terragrunt instance.
func (m *Terragrunt) WithGoBuildCache(
...
// Returns:
// - *Terragrunt: A pointer to the updated Terragrunt instance.
func (m *Terragrunt) WithGoModCache(
	// cacheRoot is the path to the cache volume's root.
	// +optional
	cacheRoot string,
	// cache is the cache volume to use.
...
// Example:
//
//	Terragrunt.WithGoInstall([]string{"github.com/Excoriate/daggerverse@latest", "github.com/another/package@v1.0"})
//
// Returns:
// - *Terragrunt: A pointer to the updated Terragrunt instance.
func (m *Terragrunt) WithGoInstall(
...
// Example:
//
//	Terragrunt.WithGoExec([]string{"build", "./..."}, "linux/amd64")
//
// Returns:
// - *Terragrunt: A pointer to the updated Terragrunt instance.
func (m *Terragrunt) WithGoExec(
...
func (m *Terragrunt) WithGoBuild(
	...
	// +optional
	buildMode string,
) *Terragrunt { // Set the target platform if provided
	m.WithGoPlatform(platform)
...
func (m *Terragrunt) buildGoArgs(opts goBuildCmdOptions) []string {
	args := []string{"build"}
...
// Returns:
// - *Terragrunt: A pointer to the updated Terragrunt instance.
func (m *Terragrunt) WithGoPrivate(
...
// Example usage:
//
//	Terragrunt.WithGCCCompiler()
//
// Returns:
// - *Terragrunt: A pointer to the updated Terragrunt instance.
func (m *Terragrunt) WithGoGCCCompiler() *Terragrunt {
	m.Ctr = m.Ctr.
...
// Returns:
// - *Terragrunt: A pointer to the updated Terragrunt instance.
func (m *Terragrunt) WithGoTestSum(
...
// Returns:
// - *Terragrunt: A pointer to the updated Terragrunt instance.
func (m *Terragrunt) WithGoReleaser(
