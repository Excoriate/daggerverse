...
// WithHTTPCurl sets up the HTTP client and configuration for the Terragrunt
...
//
// Returns:
//   - A pointer to the updated Terragrunt.
func (m *Terragrunt) WithHTTPCurl(
...
// DoHTTPRequest sets up the HTTP client and configuration for the Terragrunt
// You can configure various options like headers, authentication, etc.
//
// Example:
//
...
// Returns:
//   - A pointer to the updated Terragrunt.
func (m *Terragrunt) DoHTTPRequest(
	ctx context.Context,
...
func (m *Terragrunt) DoJSONAPICall(
	ctx context.Context,
	// method is the HTTP method (e.g., "GET", "POST").
	method string,
	// baseURL is the base URL for the HTTP requests.
