...
// WithDaggerCLIAlpine sets up the Dagger CLI entry point for Alpine within the Terragrunt.
//
// Parameters:
...
//
// Returns:
//   - *Terragrunt: Returns the modified Terragrunt instance with the Dagger CLI configured.
func (m *Terragrunt) WithDaggerCLIAlpine(version string) *Terragrunt {
...
// WithDaggerCLIUbuntu sets up the Dagger CLI entry point for Ubuntu within the Terragrunt.
//
// Parameters:
//   - version: The version of the Dagger Engine to use, e.g., "v0.12.1".
//
...
// Returns:
//   - *Terragrunt: Returns the modified Terragrunt instance with the Dagger CLI configured.
func (m *Terragrunt) WithDaggerCLIUbuntu(version string) *Terragrunt {
	daggerInstallCommand := getDaggerInstallCMDByVersion(version)
...
func (m *Terragrunt) WithDaggerDockerService(version string) *dagger.Service {
	if version == "" {
...
func (m *Terragrunt) validateDaggerVersion(dagVersion string) error {
	if dagVersion == "" {
...
//
// Returns:
//   - *Terragrunt: The modified Terragrunt instance with Dagger and Docker configured.
//   - error: An error if the setup process fails at any step.
func (m *Terragrunt) SetupDaggerInDagger(
