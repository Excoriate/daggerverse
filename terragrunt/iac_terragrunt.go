...
func (m *Terragrunt) WithTerragruntUbuntu(
...
// tfVersion - The version of Terraform to install. If empty, "latest" will be installed.
// skipTerraform - If true, Terraform installation will be skipped.
func (m *Terragrunt) WithTerragruntAlpine(
	// version is the version of Terragrunt to install. If empty, it will be installed as "latest".
	// +optional
	version string,
	// tfVersion is the version of Terraform to install. If empty, it will be installed as "latest".
...
func (m *Terragrunt) downloadAndInstallTerragrunt(version string) *dagger.Container {
...
func (m *Terragrunt) downloadAndInstallTerraformInTerragrunt(version string) *dagger.Container {
...
func (m *Terragrunt) verifyTerragruntInstallation() *Terragrunt {
	m.Ctr = m.Ctr.
...
func (m *Terragrunt) downloadRequiredUtilitiesTerragruntAlpine() *dagger.Container {
	return m.Ctr.
		WithExec([]string{"apk", "update"}).
		WithExec([]string{"apk", "add", "--no-cache", "curl", "wget", "unzip"})
}

func (m *Terragrunt) downloadRequiredUtilitiesTerragruntUbuntu() *dagger.Container {
	return m.Ctr.
