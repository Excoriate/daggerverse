...
//
// Returns:
//   - *Terragrunt: The updated Terragrunt with the AWS CLI installed in the container.
func (m *Terragrunt) WithAWSCLIInAlpineContainer() *Terragrunt {
	m.Ctr = m.Ctr.
...
// Returns:
//   - *Terragrunt: The updated Terragrunt with the AWS CLI installed in the container.
func (m *Terragrunt) WithAWSCLIInUbuntuContainer(
	// architecture is the architecture for which the AWS CLI should be downloaded.
	// Valid values are "x86_64" and "aarch64". Default is "x86_64".
	// +optional
	architecture string) *Terragrunt {
