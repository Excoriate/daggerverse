...
func (m *Tests) TestContainerWithUbuntuBase(ctx context.Context) error {
	targetModule := dag.
		Terragrunt().
		BaseUbuntu(dagger.TerragruntBaseUbuntuOpts{Version: "22.04"})
...
func (m *Tests) TestContainerWithAlpineBase(ctx context.Context) error {
	targetModule := dag.Terragrunt().
		BaseAlpine(dagger.TerragruntBaseAlpineOpts{Version: "3.17.3"})
...
func (m *Tests) TestContainerWithBusyBoxBase(ctx context.Context) error {
	targetModule := dag.
		Terragrunt().
		BaseBusyBox(dagger.TerragruntBaseBusyBoxOpts{Version: "1.35.0"})
...
func (m *Tests) TestContainerWithWolfiBase(ctx context.Context) error {
	...
	targetModuleWithInstalledPkgs := dag.
		Terragrunt().
		BaseWolfi(dagger.TerragruntBaseWolfiOpts{
