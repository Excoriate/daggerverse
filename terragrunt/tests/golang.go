...
func (m *Tests) TestGoWithGoPlatform(ctx context.Context) error {
	...
	for platform := range platforms {
		targetModule := dag.
			...
			}).WithGoPlatform(dagger.TerragruntWithGoPlatformOpts{
			Platform: platform,
		})
...
func (m *Tests) TestGoWithGoBuild(ctx context.Context) error {
	...
	targetModule = targetModule.
		...
		WithGoBuild(dagger.TerragruntWithGoBuildOpts{
...
func (m *Tests) runGoTestSumTestCase(ctx context.Context, baseModule *dagger.Terragrunt, testCase struct {
	name             string
	goTestSumVersion string
	tParseVersion    string
	skipTParse       bool
	...
	targetModule := baseModule.
		WithGoTestSum(dagger.TerragruntWithGoTestSumOpts{
...
func (m *Tests) checkToolInstallation(ctx context.Context, targetModule *dagger.Terragrunt,
...
func (m *Tests) verifyToolNotInstalled(ctx context.Context,
	targetModule *dagger.Terragrunt, toolName, testCaseName string) error {
