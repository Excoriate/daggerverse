...
func (m *Tests) testDaggerVersion(ctx context.Context, version string) error {
	...
	targetModuleUbuntu := dag.Terragrunt(dagger.TerragruntOpts{
...
func (m *Tests) TestDaggerSetupDaggerInDagger(ctx context.Context) error {
	...
	targetModule = targetModule.SetupDaggerInDagger(dagVersion, dagger.TerragruntSetupDaggerInDaggerOpts{
