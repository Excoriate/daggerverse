...
func (m *Terragrunt) WithTerraformUbuntu(
...
// Parameters:
// version - The version of Terraform to install. If empty, "latest" will be installed.
func (m *Terragrunt) WithTerraformAlpine(
	// version is the version of Terraform to install. If empty, it will be installed as "latest".
	// +optional
	version string,
) *Terragrunt {
...
func (m *Terragrunt) downloadAndInstallTerraform(version string) *dagger.Container {
...
func (m *Terragrunt) verifyTerraformInstallation() *Terragrunt {
	m.Ctr = m.Ctr.WithExec([]string{"terraform", "version"})

	return m
}

func (m *Terragrunt) downloadRequiredUtilitiesAlpine() *dagger.Container {
	return m.Ctr.
		WithExec([]string{"apk", "update"}).
		WithExec([]string{"apk", "add", "curl", "wget", "bash", "unzip", "yq"})
}

func (m *Terragrunt) downloadRequiredUtilitiesUbuntu() *dagger.Container {
	return m.Ctr.
