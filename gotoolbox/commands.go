...
func (m *Gotoolbox) OpenTerminal() *dagger.Container {
...
func (m *Gotoolbox) RunShell(cmd string) (string, error) {
...
// Usage example:
// ```go
// envVars, err := GotoolboxInstance.PrintEnvVars()
//
//	if err != nil {
...
//
// fmt.Println(envVars).
func (m *Gotoolbox) PrintEnvVars() (string, error) {
	out, err := m.
		Ctr.
...
func (m *Gotoolbox) InspectEnvVar(key string) (string, error) {
