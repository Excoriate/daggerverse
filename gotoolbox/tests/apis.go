...
func (m *Tests) TestUbuntuBase(ctx context.Context) error {
	targetModule := dag.
		Gotoolbox().
		BaseUbuntu(dagger.GotoolboxBaseUbuntuOpts{Version: "22.04"})
...
func (m *Tests) TestAlpineBase(ctx context.Context) error {
	targetModule := dag.Gotoolbox().
		BaseAlpine(dagger.GotoolboxBaseAlpineOpts{Version: "3.17.3"})
...
func (m *Tests) TestBusyBoxBase(ctx context.Context) error {
	targetModule := dag.
		Gotoolbox().
		BaseBusyBox(dagger.GotoolboxBaseBusyBoxOpts{Version: "1.35.0"})
