...
// Returns:
// - *Gotoolbox: A pointer to the updated Gotoolbox instance.
func (m *Gotoolbox) WithGoCgoEnabled() *Gotoolbox {
...
// Returns:
// - *Gotoolbox: A pointer to the updated Gotoolbox instance.
func (m *Gotoolbox) WithGoInstall(
...
func (m *Gotoolbox) WithGoBuild(
	...
	// +optional
	buildMode string,
) *Gotoolbox { // Set the target platform if provided
	m.WithGoPlatform(platform)
...
func (m *Gotoolbox) buildGoArgs(opts goBuildCmdOptions) []string {
	args := []string{"build"}
...
// Returns:
// - *Gotoolbox: A pointer to the updated Gotoolbox instance.
func (m *Gotoolbox) WithGoPrivate(
...
// Returns:
// - *Gotoolbox: A pointer to the updated Gotoolbox instance.
func (m *Gotoolbox) WithGoGCCCompiler() *Gotoolbox {
	m.Ctr = m.Ctr.
...
func (m *Gotoolbox) WithGoTestSum(
...
// Returns:
// - *ModuleTemplate: A pointer to the updated ModuleTemplate instance.
func (m *Gotoolbox) WithGoReleaser(
