...
//     Optional parameter.
func (m *Golinter) WithEnvironmentVariable(
...
func (m *Golinter) WithDockerService(
...
func (m *Golinter) WithFileMountedInContainer(
	file *File,
	dest string,
	owner string,
) *Golinter {
