...
// Example:
//
//	getDaggerInstallCMDByVersion("v0.13.7")
//	=> `cd / && DAGGER_VERSION="v0.13.7" curl -L https://dl.dagger.io/dagger/install.sh | DAGGER_VERSION="v0.13.7" sh`
...
//
// Parameters:
//   - version: The version of the Dagger Engine to use, e.g., "v0.13.7".
//
...
//
// Parameters:
//   - dagVersion: The version of the Dagger Engine to use, e.g., "v0.13.7".
