...
import (
	...
	"github.com/excoriate/daggerverse/module-template/tests/dagger/internal/querybuilder"
	"github.com/excoriate/daggerverse/module-template/tests/dagger/internal/telemetry"
)
...
// The `ModuleTemplateID` scalar type represents an identifier for an object of type ModuleTemplate.
type ModuleTemplateID string
...
type WithModuleTemplateFunc func(r *ModuleTemplate) *ModuleTemplate

// With calls the provided function with current ModuleTemplate.
//
// This is useful for reusability and readability by not breaking the calling chain.
func (r *ModuleTemplate) With(f WithModuleTemplateFunc) *ModuleTemplate {
	return f(r)
}

func (r *ModuleTemplate) WithGraphQLQuery(q *querybuilder.Selection) *ModuleTemplate {
...
func (r *ModuleTemplate) Base(imageUrl string) *ModuleTemplate {
...
func (r *ModuleTemplate) Ctr() *Container {
...
// A unique identifier for this ModuleTemplate.
func (r *ModuleTemplate) ID(ctx context.Context) (ModuleTemplateID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.query.Select("id")

	var response ModuleTemplateID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *ModuleTemplate) XXX_GraphQLType() string {
	return "ModuleTemplate"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *ModuleTemplate) XXX_GraphQLIDType() string {
	return "ModuleTemplateID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *ModuleTemplate) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *ModuleTemplate) UnmarshalJSON(bs []byte) error {
	...
	*r = *dag.LoadModuleTemplateFromID(ModuleTemplateID(id))
	return nil
}
...
func (r *ModuleTemplate) RunShell(ctx context.Context, cmd string) (string, error) {
	if r.runShell != nil {
...
func (r *ModuleTemplate) Terminal() *Terminal {
	q := r.query.Select("terminal")
...
func (r *ModuleTemplate) WithContainer(ctr *Container) *ModuleTemplate {
...
func (r *ModuleTemplate) WithDockerService(dockerVersion string) *Service {
	q := r.query.Select("withDockerService")
	q = q.Arg("dockerVersion", dockerVersion)
...
// ModuleTemplateWithEnvironmentVariableOpts contains options for ModuleTemplate.WithEnvironmentVariable
type ModuleTemplateWithEnvironmentVariableOpts struct {
	//
...
//     Optional parameter.
func (r *ModuleTemplate) WithEnvironmentVariable(name string, value string, opts ...ModuleTemplateWithEnvironmentVariableOpts) *ModuleTemplate {
...
func (r *ModuleTemplate) WithFileMountedInContainer(file *File, dest string, owner string) *ModuleTemplate {
...
// ModuleTemplateWithSourceOpts contains options for ModuleTemplate.WithSource
type ModuleTemplateWithSourceOpts struct {
	//
...
func (r *ModuleTemplate) WithSource(src *Directory, opts ...ModuleTemplateWithSourceOpts) *ModuleTemplate {
...
// Load a ModuleTemplate from its ID.
func (r *Client) LoadModuleTemplateFromID(id ModuleTemplateID) *ModuleTemplate {
	q := r.query.Select("loadModuleTemplateFromID")
	q = q.Arg("id", id)
...
// ModuleTemplateOpts contains options for Client.ModuleTemplate
type ModuleTemplateOpts struct {
	//
...
func (r *Client) ModuleTemplate(opts ...ModuleTemplateOpts) *ModuleTemplate {
	q := r.query.Select("moduleTemplate")
	for i := len(opts) - 1; i >= 0; i-- {
