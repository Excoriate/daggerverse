...
This module includes a [testing]({{.module_name_pkg}}/tests) module that aims to test the functionality of the ModuleExample module. The tests are written in Go and can be run using the following command:
