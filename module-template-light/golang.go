...
//
// Returns:
// - *ModuleTemplateLight: A pointer to the updated ModuleTemplateLight instance.
func (m *ModuleTemplateLight) WithGoPlatform(
	// platform is the target platform specified in the format "[os]/[platform]/[version]".
	// For example, "darwin/arm64/v7", "windows/amd64", "linux/arm64". If the platform
	// is not provided, it defaults to "linux/amd64".
	// +optional
...
// Returns:
// - *ModuleTemplateLight: A pointer to the updated ModuleTemplateLight instance.
func (m *ModuleTemplateLight) WithGoGCCCompilerAlpine() *ModuleTemplateLight {
	m.Ctr = m.Ctr.
		WithExec(
...
// Returns:
// - *ModuleTemplateLight: A pointer to the updated ModuleTemplateLight instance.
func (m *ModuleTemplateLight) WithGoGCCCompilerUbuntu() *ModuleTemplateLight {
	m.Ctr = m.Ctr.
		WithExec(
...
// Returns:
// - *ModuleTemplateLight: A pointer to the updated ModuleTemplateLight instance.
func (m *ModuleTemplateLight) WithGoCgoEnabled() *ModuleTemplateLight {
...
// Returns:
// - *ModuleTemplateLight: A pointer to the updated ModuleTemplateLight instance.
func (m *ModuleTemplateLight) WithCgoDisabled() *ModuleTemplateLight {
...
// Returns:
// - *ModuleTemplateLight: A pointer to the updated ModuleTemplateLight instance.
func (m *ModuleTemplateLight) WithGoBuildCache(
...
// Returns:
// - *ModuleTemplateLight: A pointer to the updated ModuleTemplateLight instance.
func (m *ModuleTemplateLight) WithGoModCache(
	// cacheRoot is the path to the cache volume's root.
	// +optional
	cacheRoot string,
	// cache is the cache volume to use.
...
// Returns:
// - *ModuleTemplateLight: A pointer to the updated ModuleTemplateLight instance.
func (m *ModuleTemplateLight) WithGoInstall(
...
// Returns:
// - *ModuleTemplateLight: A pointer to the updated ModuleTemplateLight instance.
func (m *ModuleTemplateLight) WithGoExec(
