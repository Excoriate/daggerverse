...
func (m *ModuleTemplateLight) setupContainer(image, version string) error {
	if image != "" {
...
func (m *ModuleTemplateLight) setupCustomImage(image string) error {
...
func (m *ModuleTemplateLight) setupDefaultImage(version string) error {
	if version == "" {
...
func (m *ModuleTemplateLight) setupEnvironmentVariables(envVarsFromHost []string) error {
