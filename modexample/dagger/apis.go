...
//     Optional parameter.
func (m *Modexample) WithEnvironmentVariable(
...
func (m *Modexample) WithContainer(
	ctr *Container,
) *Modexample {
	m.Ctr = ctr
...
func (m *Modexample) WithDockerService(
...
func (m *Modexample) WithFileMountedInContainer(
	file *File,
	dest string,
	owner string,
) *Modexample {
