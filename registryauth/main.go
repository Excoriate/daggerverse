// Package main provides the Registryauth Dagger module and related functions.
//
...
// Registryauth is a Dagger module.
//
...
// New creates a new Registryauth module.
//
// Parameters:
...
func (m *Registryauth) Base(imageURL string) *Registryauth {
