...
// The `RegistryauthID` scalar type represents an identifier for an object of type Registryauth.
...
// Load a Registryauth from its ID.
func (r *Client) LoadRegistryauthFromID(id RegistryauthID) *Registryauth {
	q := r.query.Select("loadRegistryauthFromID")
	q = q.Arg("id", id)
...
// RegistryauthOpts contains options for Client.Registryauth
...
func (r *Client) Registryauth(opts ...RegistryauthOpts) *Registryauth {
	q := r.query.Select("registryauth")
	for i := len(opts) - 1; i >= 0; i-- {
		...
		// `envVarsFromHost` optional argument
		if !querybuilder.IsZeroValue(opts[i].EnvVarsFromHost) {
			q = q.Arg("envVarsFromHost", opts[i].EnvVarsFromHost)
		}
	}
...
type WithRegistryauthFunc func(r *Registryauth) *Registryauth

// With calls the provided function with current Registryauth.
//
// This is useful for reusability and readability by not breaking the calling chain.
func (r *Registryauth) With(f WithRegistryauthFunc) *Registryauth {
	return f(r)
}

func (r *Registryauth) WithGraphQLQuery(q *querybuilder.Selection) *Registryauth {
	return &Registryauth{
		query: q,
	}
}
...
func (r *Registryauth) Base(imageUrl string) *Registryauth {
	q := r.query.Select("base")
	q = q.Arg("imageUrl", imageUrl)
...
// RegistryauthBaseAlpineOpts contains options for Registryauth.BaseAlpine
type RegistryauthBaseAlpineOpts struct {
	//
...
func (r *Registryauth) BaseAlpine(opts ...RegistryauthBaseAlpineOpts) *Registryauth {
	q := r.query.Select("baseAlpine")
	for i := len(opts) - 1; i >= 0; i-- {
		// `version` optional argument
		if !querybuilder.IsZeroValue(opts[i].Version) {
			q = q.Arg("version", opts[i].Version)
...
// RegistryauthBaseBusyBoxOpts contains options for Registryauth.BaseBusyBox
type RegistryauthBaseBusyBoxOpts struct {
	//
...
//
// Returns a pointer to the Registryauth instance.
func (r *Registryauth) BaseBusyBox(opts ...RegistryauthBaseBusyBoxOpts) *Registryauth {
	q := r.query.Select("baseBusyBox")
	for i := len(opts) - 1; i >= 0; i-- {
		// `version` optional argument
		if !querybuilder.IsZeroValue(opts[i].Version) {
			q = q.Arg("version", opts[i].Version)
...
// RegistryauthBaseUbuntuOpts contains options for Registryauth.BaseUbuntu
type RegistryauthBaseUbuntuOpts struct {
	//
...
//
// Returns a pointer to the Registryauth instance.
func (r *Registryauth) BaseUbuntu(opts ...RegistryauthBaseUbuntuOpts) *Registryauth {
	q := r.query.Select("baseUbuntu")
	for i := len(opts) - 1; i >= 0; i-- {
		// `version` optional argument
		if !querybuilder.IsZeroValue(opts[i].Version) {
			q = q.Arg("version", opts[i].Version)
...
// RegistryauthBaseWolfiOpts contains options for Registryauth.BaseWolfi
type RegistryauthBaseWolfiOpts struct {
	//
...
//
// Returns a pointer to the Registryauth instance.
func (r *Registryauth) BaseWolfi(opts ...RegistryauthBaseWolfiOpts) *Registryauth {
	q := r.query.Select("baseWolfi")
	for i := len(opts) - 1; i >= 0; i-- {
		// `version` optional argument
		if !querybuilder.IsZeroValue(opts[i].Version) {
			q = q.Arg("version", opts[i].Version)
...
// Ctr is the container to use as a base container.
func (r *Registryauth) Ctr() *Container {
...
// A unique identifier for this Registryauth.
func (r *Registryauth) ID(ctx context.Context) (RegistryauthID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.query.Select("id")
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *Registryauth) XXX_GraphQLType() string {
	return "Registryauth"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *Registryauth) XXX_GraphQLIDType() string {
	return "RegistryauthID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *Registryauth) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *Registryauth) UnmarshalJSON(bs []byte) error {
	...
	*r = *dag.LoadRegistryauthFromID(RegistryauthID(id))
	return nil
}
...
func (r *Registryauth) OpenTerminal() *Container {
	q := r.query.Select("openTerminal")
...
//
// fmt.Println(envVars).
func (r *Registryauth) PrintEnvVars(ctx context.Context) (string, error) {
	if r.printEnvVars != nil {
		return *r.printEnvVars, nil
	}
	q := r.query.Select("printEnvVars")
...
func (r *Registryauth) RunShell(ctx context.Context, cmd string) (string, error) {
	if r.runShell != nil {
		return *r.runShell, nil
	}
	q := r.query.Select("runShell")
	q = q.Arg("cmd", cmd)
...
func (r *Registryauth) WithCacheBuster() *Registryauth {
	q := r.query.Select("withCacheBuster")
...
func (r *Registryauth) WithContainer(ctr *Container) *Registryauth {
...
// RegistryauthWithEnvironmentVariableOpts contains options for Registryauth.WithEnvironmentVariable
type RegistryauthWithEnvironmentVariableOpts struct {
	//
...
//     Optional parameter.
func (r *Registryauth) WithEnvironmentVariable(name string, value string, opts ...RegistryauthWithEnvironmentVariableOpts) *Registryauth {
	q := r.query.Select("withEnvironmentVariable")
	for i := len(opts) - 1; i >= 0; i-- {
		// `expand` optional argument
		if !querybuilder.IsZeroValue(opts[i].Expand) {
			q = q.Arg("expand", opts[i].Expand)
...
func (r *Registryauth) WithFileMountedInContainer(file *File, dest string, owner string) *Registryauth {
	assertNotNil("file", file)
	q := r.query.Select("withFileMountedInContainer")
	q = q.Arg("file", file)
	q = q.Arg("dest", dest)
	q = q.Arg("owner", owner)
