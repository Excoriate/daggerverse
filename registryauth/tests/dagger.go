...
func (m *Tests) testDaggerVersion(ctx context.Context, version string) error {
	...
	targetModuleUbuntu := dag.Registryauth(dagger.RegistryauthOpts{
...
func (m *Tests) TestDaggerSetupDaggerInDagger(ctx context.Context) error {
	...
	targetModule = targetModule.SetupDaggerInDagger(dagVersion, dagger.RegistryauthSetupDaggerInDaggerOpts{
