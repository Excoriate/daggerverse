	...
	for _, version := range versions {
		...
		targetModule := dag.
			...
			WithTerraformAlpine(dagger.
				RegistryauthWithTerraformAlpineOpts{
				Version: version,
			})
...
func (m *Tests) verifyTerraformInstallation(ctx context.Context, module *dagger.Registryauth, version string) error {
...
func (m *Tests) verifyTerraformInPath(ctx context.Context, module *dagger.Registryauth, version string) error {
...
func (m *Tests) verifyTerraformHelp(ctx context.Context, module *dagger.Registryauth, version string) error {
...
func (m *Tests) TestIACWithTerraformUbuntu(ctx context.Context) error {
	...
	for _, version := range versions {
		...
		targetModule := dag.
			...
			WithTerraformUbuntu(dagger.RegistryauthWithTerraformUbuntuOpts{
				Version: version,
			})
