...
func (m *Tests) TestContainerWithUbuntuBase(ctx context.Context) error {
	targetModule := dag.
		Registryauth().
		BaseUbuntu(dagger.RegistryauthBaseUbuntuOpts{Version: "22.04"})
...
func (m *Tests) TestContainerWithAlpineBase(ctx context.Context) error {
	targetModule := dag.Registryauth().
		BaseAlpine(dagger.RegistryauthBaseAlpineOpts{Version: "3.17.3"})
...
func (m *Tests) TestContainerWithBusyBoxBase(ctx context.Context) error {
	targetModule := dag.
		Registryauth().
		BaseBusyBox(dagger.RegistryauthBaseBusyBoxOpts{Version: "1.35.0"})
...
func (m *Tests) TestContainerWithWolfiBase(ctx context.Context) error {
	...
	targetModuleWithInstalledPkgs := dag.
		Registryauth().
		BaseWolfi(dagger.RegistryauthBaseWolfiOpts{
