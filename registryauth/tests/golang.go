...
func (m *Tests) TestGoWithGoPlatform(ctx context.Context) error {
	...
	for platform := range platforms {
		targetModule := dag.
			Registryauth(dagger.RegistryauthOpts{
				Ctr: getGolangAlpineContainer(""),
			}).WithGoPlatform(dagger.RegistryauthWithGoPlatformOpts{
			Platform: platform,
		})
...
func (m *Tests) TestGoWithGoBuild(ctx context.Context) error {
	...
	targetModule = targetModule.
		...
		WithGoBuild(dagger.RegistryauthWithGoBuildOpts{
...
func (m *Tests) runGoTestSumTestCase(ctx context.Context, baseModule *dagger.Registryauth, testCase struct {
	name             string
	goTestSumVersion string
	tParseVersion    string
	skipTParse       bool
	...
	targetModule := baseModule.
		WithGoTestSum(dagger.RegistryauthWithGoTestSumOpts{
...
func (m *Tests) checkToolInstallation(ctx context.Context, targetModule *dagger.Registryauth,
...
func (m *Tests) verifyToolNotInstalled(ctx context.Context,
	targetModule *dagger.Registryauth, toolName, testCaseName string) error {
